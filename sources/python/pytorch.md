...
An example transformer block from the pytorch documentation.

```python
class MultiHeadAttention(nn.Module):
	"""
	Computes multiheaded attention. Supports nested or padded tensors.
